      ...
      , t = {
        ...
        offcanvas: function(t, a) {
            ...
            c('[data-dismiss="offcanvas"]').on("click", function() {
                ...
                c(o).removeClass("offcanvas-open", a)
            })
        },
            ...
            window.addEventListener("load", function() {
                ...
                Array.prototype.filter.call(t, function(a) {
                    a.addEventListener("submit", function(t) {
                        !1 === a.checkValidity() && (t.preventDefault(),
                        t.stopPropagation()),
        ...
        multilevelDropdown: function(t) {
            c(".dropdown-menu [data-toggle='dropdown']").on("click", function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                c(this).siblings().toggleClass("show"),
                c(this).next().hasClass("show") || c(this).parents(".dropdown-menu").first().find(".show").removeClass("show"),
                c(this).parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown", function() {
        ...
        rangeSlider: function(t) {
            c(".range-slider").each(function() {
                ...
                a[0].noUiSlider.on("update", function(t, a) {
                    var e = t[a];
                    a ? (n.valueMax.text(Math.round(e)),
                    n.valueMaxInput.val(Math.round(e))) : (n.valueMin.text(Math.round(e)),
                    n.valueMinInput.val(Math.round(e)))
                })
            })
        },
        dataFilter: function(t, a) {
            a = '[data-filter="target"]',
            c('[data-filter="trigger"]').on("change", function() {
                var t = c(this).find("option:selected").val().toLowerCase();
                c(a).css("display", "none"),
                c("#" + t).css("display", "table-row-group"),
                "all" === t && c(a).css("display", "table-row-group")
            })
        },
        subscribeForm: function(t, a, e, n) {
            ...
            o.length && i.bind("click", function(t) {
                ...
                c.ajax({
                    ...
                    error: function(t) {
                        r.removeClass("status-error").addClass("status-success").text("Thank you for subscribing");
                        i.text(l, setTimeout(function() {
                            r.removeClass("status-success").text("")
                        }, 5e3))
                    },
                    success: function(t) {
                        "success" === t.result ? (r.removeClass("status-error").addClass("status-success").text("Thank you for subscribing. We have sent you a confirmation email."),
                        i.text(l, setTimeout(function() {
                            r.removeClass("status-success").text("")
                        }, 5e3)),
                        s.val("")) : (r.removeClass("status-success").addClass("status-error").text(t.msg.substring(4)),
                        i.text(l, setTimeout(function() {
        ...
        productGallery: function(t) {
            c(t = ".product-carousel").length && c(t).owlCarousel({
                ...
                onTranslate: function(t) {
                    ...
                    c('[href="#' + e + '"]').parent().addClass("active"),
                    c('[data-hash="' + e + '"]').parent().addClass("active")
                }
            })
        },
        ...
        linkedCarousels: function(t, e) {
            e = c(t = ".trigger-carousel").data("target-carousel"),
            c(t).length && c(t).on("change.owl.carousel", function(t) {
