  ...
  <div class="col-md-9 col-sm-7">
    ...
    <div class="content-page">
      <div class="content-form-page">
        <form role="form" method='POST' action="{{ route('city.store') }}" class="form-horizontal form-without-legend">
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="number"  id="name" name="lat" class="form-control" step="any" >
                </div>
            </div>
            <div class="form-group">
